...
export default function ModalRegister() {
  ...
  const [isUserAgreed, setAgreed] = useState(false);
  // ----------------------------------------------------------------
  ...
  const TermsOnChange = (event: React.ChangeEvent<HTMLInputElement>) => {
      ...
      <div className="modal-dialog">
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <div className="d-flex gap-2">
              <div>
                ...
                <input
                  ...
                  value={fname}
                />
                <div className="invalid-feedback">Invalid Fisrt name</div>
              </div>
              <div>
            ...
            <div className="mt-2">
              ...
              <div>
                ...
                {!gender && genderErr && <div className="text-danger">Please select gender</div>} 
              </div>
            </div>
          ...
          <div className="modal-footer">
            ...
            <div>
              <input className="me-2 form-check-input" type="checkbox" onChange={TermsOnChange}/>I agree
